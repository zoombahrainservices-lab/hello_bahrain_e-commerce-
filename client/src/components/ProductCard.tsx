...
export default function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <div
      className="group border border-transparent hover:border-gray-300 rounded-lg overflow-hidden transition-all duration-300 flex flex-col relative"
    ...
    >
      <Link href={`/product/${product.slug}`} className="flex-1 flex flex-col">
        ...
        <div className="p-4 flex-1 flex flex-col">
          ...
          {/* Product Title */}
          <h3 className="text-[15px] font-semibold text-gray-900 mb-2 truncate group-hover:text-primary-600 transition pr-[52px]" title={product.name}>
            {product.name}
          </h3>
