...
import ResponsiveProductImage, { getProductImageVariants } from '@/components/ResponsiveProductImage';
          ...
          <div className="relative aspect-square mb-4 bg-gray-100 rounded-lg overflow-hidden border border-gray-200 group cursor-zoom-in">
            {brokenImages.has(selectedImage) ? (
              ...
              <ResponsiveProductImage
                ...
                variants={getProductImageVariants(product, selectedImage)}
                usage="detail"
                alt={product.name}
                fill
            ...
            {images.map((img, idx) => (
              ...
              >
                {brokenImages.has(idx) ? (
                  ...
                  <ResponsiveProductImage
                    src={img}
                    variants={getProductImageVariants(product, idx)}
