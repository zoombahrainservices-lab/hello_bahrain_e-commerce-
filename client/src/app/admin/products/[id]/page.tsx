    ...
    try {
      ...
      if (product) {
        ...
        setFormData({
          ...
          promotionalLabelColor: product.promotionalLabelColor || '#ef4444',
        });
        setImages(allImages);
      } else {
      ...
      <div className="bg-white rounded-lg shadow-md p-6 max-w-3xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="border-t pt-4">
            <h3 className="text-lg font-semibold mb-4">Promotional Label</h3>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Label Text (e.g., "SALE", "50% OFF", "HOT")
                </label>
                <input
                  type="text"
                  ...
                  onChange={handleChange}
                  placeholder="Leave empty to use auto-generated labels"
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                />
                <p className="mt-1 text-xs text-gray-500">
                  Optional: Custom promotional label. If empty, auto-labels will be used based on product status.
                </p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                ...
                <div className="flex items-center gap-2">
                  <input
                    type="color"
                    name="promotionalLabelColor"
                    value={formData.promotionalLabelColor}
                    onChange={handleChange}
                  ...
                  <input
                    type="text"
                    value={formData.promotionalLabelColor}
                    onChange={(e) => setFormData({ ...formData, promotionalLabelColor: e.target.value })}
                    placeholder="#ef4444"
                    className="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                  />
                </div>
                <p className="mt-1 text-xs text-gray-500">
                  Choose a color for the promotional label background
                </p>
              </div>
            </div>
          </div>
